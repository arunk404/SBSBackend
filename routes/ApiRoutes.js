...
router.post('/servicecontract/add/', adminManagerMiddleware, createServiceContractValidate, ServiceController.addServiceContracts);
router.put('/servicecontract/update/', adminManagerMiddleware, createServiceContractValidate, ServiceController.updateServiceContracts);
